    ...
    <section class="panel overflow-hidden">
        ...
        <div class="grid grid-cols-2 gap-px bg-slate-200 dark:bg-slate-800 lg:grid-cols-3">
            @foreach($recent as $complaint)
                <article class="group min-w-0 bg-white p-3 transition hover:bg-slate-50 dark:bg-slate-900 dark:hover:bg-slate-800/70 sm:p-4">
                    ...
                    <div class="mt-3 grid grid-cols-[1fr_auto] gap-2">
                        ...
                        <a href="{{ route('complaints.show', $complaint) }}" wire:navigate class="inline-flex items-center justify-center rounded-xl bg-blue-600 px-3 py-2 text-[10px] font-black text-white transition hover:bg-blue-700 sm:text-xs">Detail</a>

                        <x-map.directions-link :latitude="$complaint->latitude" :longitude="$complaint->longitude" compact />
